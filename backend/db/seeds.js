...
sequelize
	...
	.then(() => {
		...
		stores.forEach((address) => Store.create(address));
	})
	// .then(() => {
	// 	// Rellenar posts
	// 	breeds.forEach((post) => PetBreed.create(post));
	// })
	.then(() => {
		// Rellenar posts
		petTypess.forEach((post) => PetType.create(post));
	})
	// .then(() => {
	// 	// Rellenar posts
	// 	pets.forEach((post) => Pet.create(post));
	// })
	.then(() => {
		// Rellenar posts
		statues.forEach((post) => Status.create(post));
	});
